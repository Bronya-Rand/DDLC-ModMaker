...
init python hide:
    ...
    __("I'm using Gradle to build the mod.")
    ...
    __("What is the full name of your mod? This name will appear in the list of installed apps.")
    __("What is the short name of your mod? This name will be used in the launcher, and for app shortcuts.")
    __("What is the name of the package?\n\nThis is usually of the form com.domain.buildname i.e. com.monika.mas. It may only contain ASCII letters and dots. It must contain at least one dot.")
    ...
    __("It looks like you're ready to start packaging mods.")
