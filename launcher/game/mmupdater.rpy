...
label mmupdater(silent=False):
    ...
    python hide:
        ...
        try:
            if datetime.date.today() > persistent.last_update_check:
                ...
                template_json_file = open(config.basedir + "/update/template_current.json", "w")
                mmaker_json_file = open(config.basedir + "/update/mmaker_current.json", "w")
        ...
        try:
            template_json = open(config.basedir + "/update/template_current.json", "r")
            mmaker_json = open(config.basedir + "/update/mmaker_current.json", "r")
        except:
            if not silent:
