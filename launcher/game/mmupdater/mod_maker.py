...
class ModTool(MMakerGithubTool):
    ...
    def __init__(self):
        super().__init__("GanstaKingofSA/DDLC-ModMaker",
                        "mmaker-7.4",
                        "DDMMaker",
                        "Doki Doki Mod Maker",
                        "DDMM",
                        "bronya_rand",
                        "DDMM is a Ren'Py SDK Modification that makes DDLC Modding easier and efficient with better wording, auto-tool install, and more! This tool adheres to the Team Salvato IP Guidelines and RenpyTom Guidelines for DDLC and Ren'Py SDK modding.",
                        True, False)
